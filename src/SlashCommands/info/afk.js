     ...
     run: async ({client, interaction, args}) => {
        ...
        let embed = new MessageEmbed()
            ...
            if(!data) {
                ...
                interaction.followUp({embeds: [embed.setColor("BLURPLE").setDescription(`You have been set to afk\n\n`+`\n**__Reason__:** \n \`${content}\` `)]})
            } else {
                ...
                interaction.followUp({embeds: [embed.setDescription(`Your afk status has been updated!\n\n`+` **__Reason__:** \n \`${content}\` `)]})

            }
        } else {
            interaction.followUp({ content: 'Please enter mongopath to use afk mode!'})
        }
